...
import com.cnoom.node.EventNode3Arg;

public class EventCollection3Arg<T1, T2, T3> extends BaseNodeCollection<EventNode3Arg<T1, T2, T3>> implements Event3Arg<T1, T2, T3> {
    @Override
